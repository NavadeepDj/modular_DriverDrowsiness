...
class DrowsinessDetectionSystem:
        ...
        try:
            while True:
                ...
                if face_landmarks:
                    ...
                    # Draw MediaPipe-based eye boundaries for visualization
                    if left_eye and right_eye:
                        self.detector.draw_eye_contours(frame, left_eye, right_eye)
                    ...
                    if ear is not None:
                        ...
                        # Estimate head pose & attentiveness
                        yaw, pitch, roll, looking = self.head_pose.estimate(
                            face_landmarks, frame.shape
                        )
                        ...
                        # If driver is clearly not looking at the road/camera,
                        # override high-level label to emphasise *attentiveness*
                        ...
                        # Display information on frame (drowsiness + attentiveness)
                        self._draw_info(
                            frame,
                            state,
                            score,
    ...
    def _draw_info(
        ...
        # Draw head-pose / attentiveness info if available
